...
"""
a,b = np.loadtxt('BubbleSort/valores_C++_2.txt',delimiter = ',',unpack = True)
c,d = np.loadtxt('CountingSort/valores_C++_2.txt',delimiter = ',',unpack = True)
e,f = np.loadtxt('HeapSort/valores_C++_2.txt',delimiter = ',',unpack = True)
g,h = np.loadtxt('InsertionSort/valores_C++_2.txt',delimiter = ',',unpack = True)
i,j = np.loadtxt('MergeSort/valores_C++_2.txt',delimiter = ',',unpack = True)
k,l = np.loadtxt('Quicksort/valores_C++_2.txt',delimiter = ',',unpack = True)
m,n = np.loadtxt('SelectionSort/valores_C++_2.txt',delimiter = ',',unpack = True)
